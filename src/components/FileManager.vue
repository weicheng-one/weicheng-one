<template>
  <TransitionRoot as="template" :show="fileManagerStore.open">
    <Dialog as="div" class="relative z-10">
      ...
      <div class="fixed inset-0 z-10 overflow-y-auto">
        ...
        >
          ...
          >
            <DialogPanel
              class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all w-full max-w-3xl p-2"
            >
              <div class="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                <button
                  type="button"
                  class="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  @click="fileManagerStore.open = false"
                >
